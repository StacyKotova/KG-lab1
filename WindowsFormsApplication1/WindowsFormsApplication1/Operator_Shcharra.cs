...
{
    class Operator_Shcharra : Filter
    {
        protected float[,] kernel_Gx = null;
        protected float[,] kernel_Gy = null;

        public Operator_Shcharra()
        {
            kernel_Gx = new float[3, 3] { { 3, 0, -3 }, { 10, 0, -10 }, { 3, 0, -3 } };
            kernel_Gy = new float[3, 3] { { 3, 10, 3 }, { 0, 0, 0 }, { -3, -10, -3 } };
        }
        public Operator_Shcharra(float[,] kernel_1, float[,] kernel_2)
        {
